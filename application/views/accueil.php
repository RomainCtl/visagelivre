<h2>Accueil</h2> 
<?php if(isset($_SESSION['user'])){//est connecté?> 
...
<div style='margin:5px 0;'>
    <?php echo form_open('visagelivre/ajoutBillet/-1') ?> 
    <label>Ajouter un post : </label><textarea name="content"></textarea> <input type="submit" />
    </form>
</div>
